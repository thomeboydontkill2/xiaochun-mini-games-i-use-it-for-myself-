...
WORD_DM_MESSAGES = [
    "你的词是「{word}」哦。描述的时候别太明显，会被发现的~<:tou_xiao:1536150632426111078>",
    "拿着这个词——「{word}」。嘛，怎么描述就看你的了。<:xianhua:1536148788228522075>",
    "嘘，你的词是「{word}」。别直接说出来哦，我会看你们怎么表演的。<:hao_qi:1536144194073133148>",
    "词给你了：「{word}」。哦哦，这个有意思，别露馅哦。<:ao_jiao:1536137032932532254>",
    "你的词：「{word}」。能不能混过去就看你的嘴皮子了。<:ghost_face:1536141788065038468>",
    "拿好——「{word}」。提示一下，别描述得太准，也别太离谱。<:guai_qiao:1536143570120085655>",
    "词是「{word}」。嘛，我倒要看看你怎么描述它。<:chi_gua:1536139781875179592>",
    "你的词：「{word}」。别紧张，越紧张越容易被怀疑哦~<:tou_xiao:1536150632426111078>",
    "拿着——「{word}」。哦哦，这个我熟，看你表演了。<:ao_jiao:1536137032932532254>",
    "词是「{word}」。嘘，别让别人看到这条消息。<:guai_qiao:1536143570120085655>",
    "你的词：「{word}」。嘛，描述得太好和太差都危险哦。<:xianhua:1536148788228522075>",
    "拿好这个词——「{word}」。我赌你能不能混过去。<:chi_gua:1536139781875179592>",
    "词：「{word}」。诶嘿，我有点期待你被怀疑时的表情了。<:tou_xiao:1536150632426111078>",
    "你的词是「{word}」。别直接说，别太离谱，别太准——就这三条。<:hao_qi:1536144194073133148>",
]
